...
final class EncodingTagsTest extends TestCase
{
    ...
    public function createValidBase16EncodingTag(): void
    {
        ...
        static::assertEquals(CBORObject::TAG_ENCODED_BASE16, $tag->getAdditionalInformation());
    }
    ...
    public function createValidBase64EncodingTag(): void
    {
        ...
        static::assertInstanceOf(TextStringObject::class, $tag->getValue());
        static::assertEquals(CBORObject::MAJOR_TYPE_TAG, $tag->getMajorType());
        static::assertEquals(CBORObject::TAG_ENCODED_BASE64, $tag->getAdditionalInformation());
    }
    ...
    public function createValidBase64UrlEncodingTag(): void
    {
        ...
        static::assertInstanceOf(TextStringObject::class, $tag->getValue());
        static::assertEquals(CBORObject::MAJOR_TYPE_TAG, $tag->getMajorType());
        static::assertEquals(CBORObject::TAG_ENCODED_BASE64_URL, $tag->getAdditionalInformation());
    }
    ...
    public function createValidCBOREncodingTag(): void
    {
        ...
        static::assertEquals(CBORObject::MAJOR_TYPE_TAG, $tag->getMajorType());
        static::assertEquals(CBORObject::TAG_ENCODED_CBOR, $tag->getAdditionalInformation());
    }
