...
final class InvalidTypeTest extends BaseTestCase
{
    ...
    {
        return [
            [base_convert('00000011100', 2, 16), InvalidArgumentException::class, 'Cannot parse the data. Found invalid Additional Information "00011100" (28).'],
            [base_convert('00000011101', 2, 16), InvalidArgumentException::class, 'Cannot parse the data. Found invalid Additional Information "00011101" (29).'],
            [base_convert('00000011110', 2, 16), InvalidArgumentException::class, 'Cannot parse the data. Found invalid Additional Information "00011110" (30).'],
            ...
            ['7b7fffffffffffffff010203', InvalidArgumentException::class, 'Out of range. Expected: 9223372036854775807, read: 0.'],
